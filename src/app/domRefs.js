export function getMainDomRefs() {
  return {
    ...
    postFlightEffectField: document.getElementById('postFlightEffectField'),
    editPostFlightEffectDuration: document.getElementById('editPostFlightEffectDuration'),
    postFlightEffectDurationField: document.getElementById('postFlightEffectDurationField'),
